...
% Name         : Reshav Sain
% T-square ID  : rsain3
% GT Email     : seanrsain@gatech.edu
% Homework     : 14/original
% Course       : CS1371
% Section      : A06
% Collaboration: I worked on the homework assignment alone, but used the
...
%           surf(xxCap1_soln, yyCap1_soln, zzCap1_soln) when 
%           [xxCap1_soln, yyCap1_soln, zzCap1_soln] = makeCap_soln(3, [1 0]) is
%           run.
% 
...
%           surf(xxBill1_soln, yyBill1_soln, zzBill1_soln) when 
...
% 
%   [xxProp1, yyProp1, zzProp1] = makePropeller(0, 4*pi, 1)
%       => surf(xxProp1, yyProp1, zzProp1) should look identical to 
%           surf(xxProp1_soln, yyProp1_soln, zzProp1_soln) when 
...
%           surf(xxProp2_soln, yyProp2_soln, zzProp2_soln) when 
