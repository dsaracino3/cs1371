...
%   text1 = jackBlack(M1, R1, 'MovieData.xlsx')
...
%   text2 = jackBlack(M2, R2, 'MovieData.xlsx')
...
%   text3 = jackBlack(M3, R3, 'MovieData.xlsx')
...
%
%   load('results.mat')
%   [best1, results1] = superSmashBros('battlefield_Characters.xls', 'battlefield_Scores.xls')
%       best1 => 'Alexis won the most games and is the best player!'
%       results1 => should be equal to results1_soln
%      
%   [best2, results2] = superSmashBros('hyruleCastle_Characters.xls', 'hyruleCastle_Scores.xls')
%       best2 => 'Michael won the most games, but Kyle is the best player!'
%       results2 => should be equal to results2_soln
%
%   [best3, results3] = superSmashBros('sectorZ_Characters.xls', 'sectorZ_Scores.xls')
