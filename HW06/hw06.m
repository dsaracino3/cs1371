...
% Course       : CS1371
% Section      : A06
% Collaboration: I worked on the homework assignment with Mohit Chauhan,
%                and used the mathworks website.
%
%
...
%
%   out1 = battleRoyal('Kane,Undertaker,John Cena',[91,93,96],...
%          [false,false,true])
%       out1 => 'John Cena wins by absolute domination!!!'
%
%   out2 = battleRoyal('Rey Mysterio,Seth Rollins,The Great Khali',...
%          [84,89,84],[true,false,false])
%       out2 => 'Seth Rollins wins by a landslide!'
%
%   out3 = battleRoyal('Batista,The Rock,Big Show',[88,91,87],...
%          [false,true,false])
